...
function InitialiseAudio()
	...
	kAudioBufferWood = FCAudio.CreateBuffer( "Assets/Audio/wood" )
	kAudioBufferClink = FCAudio.CreateBuffer( "Assets/Audio/clink" )
	kAudioBufferTurbine = FCAudio.CreateBuffer( "Assets/Audio/turbine" )
end
