...
#		print( indices )
	...
	def processUntexturedShaderMesh( self, mesh, bm, meshElement, vertexBufferElement, indexBufferElement ):
		pass
...
def register():
	...
	FCShaderTypes = [("Wireframe", "Wireframe", "Wireframe"), ("Untextured", "Untextured", "Untextured"), ("Test", "Test", "Test")]
